...
set(CMAKE_VS_DEBUGGER_ENVIRONMENT "PATH=$<$<CONFIG:Release>:C:/Users/julia/.conan2/p/catch56a8a66b231dc/p/bin>;%PATH%")
endif()
...
list(PREPEND CMAKE_MODULE_PATH "C:/Users/julia/.conan2/p/catch56a8a66b231dc/p/lib/cmake/Catch2")
# the generators folder (where conan generates files, like this toolchain)
list(PREPEND CMAKE_MODULE_PATH ${CMAKE_CURRENT_LIST_DIR})

# Definition of CMAKE_PREFIX_PATH, CMAKE_XXXXX_PATH
# The explicitly defined "builddirs" of "host" context dependencies must be in PREFIX_PATH
list(PREPEND CMAKE_PREFIX_PATH "C:/Users/julia/.conan2/p/catch56a8a66b231dc/p/lib/cmake/Catch2")
# The Conan local "generators" folder, where this toolchain is saved.
list(PREPEND CMAKE_PREFIX_PATH ${CMAKE_CURRENT_LIST_DIR} )
list(PREPEND CMAKE_LIBRARY_PATH "C:/Users/julia/.conan2/p/catch56a8a66b231dc/p/lib")
list(PREPEND CMAKE_INCLUDE_PATH "C:/Users/julia/.conan2/p/catch56a8a66b231dc/p/include")
set(CONAN_RUNTIME_LIB_DIRS "$<$<CONFIG:Release>:C:/Users/julia/.conan2/p/catch56a8a66b231dc/p/bin>" )
