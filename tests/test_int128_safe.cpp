...
void test_safe_conversions_to_integral()
{
    ...
    std::cout << "  ✅ Conversión exitosa a int: " << result_int.value << "\n";
    ...
    std::cout << "  ✅ Detección de overflow funciona\n";
    ...
    std::cout << "  ✅ Conversión de valor negativo: " << result_neg.value << "\n";
    ...
    std::cout << "  ✅ Detección de underflow funciona\n";
}
...
void test_safe_conversions_to_float()
{
    ...
    std::cout << "  ✅ Conversión a double: " << result.value << "\n";
    ...
    std::cout << "  ✅ Conversión negativa a double: " << result_neg.value << "\n";
    ...
    std::cout << "  ✅ Conversión de valor grande funciona\n";
}

void test_checked_conversions()
{
    std::cout << "✅ Probando conversiones con excepciones...\n";
    ...
    try {
        ...
        assert(result == 100);
        std::cout << "  ✅ checked_cast exitoso: " << result << "\n";
    } catch (...) {
    ...
    try {
        ...
        std::cout << "  ✅ Excepción de overflow capturada correctamente\n";
    } catch (...) {
...
void test_optional_conversions()
{
    ...
    std::cout << "  ✅ try_cast exitoso: " << result.value() << "\n";
    ...
    std::cout << "  ✅ try_cast falla correctamente\n";
}
...
void test_safe_arithmetic()
{
    ...
    std::cout << "  ✅ Adición segura: " << add_result.value << "\n";
    ...
    std::cout << "  ✅ Detección de underflow en sustracción\n";
    ...
    std::cout << "  ✅ Detección de división por cero\n";
}
...
void test_safe_shifts()
{
    ...
    std::cout << "  ✅ Shift izquierdo seguro: " << shl_result.value << "\n";
    ...
    std::cout << "  ✅ Shift derecho seguro: " << shr_result.value << "\n";
...
void test_range_utilities()
{
    ...
    std::cout << "  ✅ clamp funciona correctamente\n";
    ...
    std::cout << "  ✅ saturating_add funciona\n";
    ...
    std::cout << "  ✅ saturating_sub funciona\n";
}
...
void test_safe_abs()
{
    ...
    std::cout << "  ✅ safe_abs normal: " << abs_result.value << "\n";
    ...
    std::cout << "  ✅ safe_abs de positivo: " << abs_pos.value << "\n";
    ...
    std::cout << "  ✅ Detección de overflow en abs(min)\n";
    ...
    std::cout << "  ✅ saturating_abs funciona\n";
}
...
void test_construction_from_other_types()
{
    ...
    std::cout << "  ✅ Construcción desde float negativo: " << from_neg_float.value << "\n";
}
...
int main()
{
    ...
    try {
        ...
        std::cout << "=====================================\n";
        std::cout << "✅ Conversiones seguras funcionando\n";
        std::cout << "✅ Detección de overflow/underflow funcionando\n";
        std::cout << "✅ Operaciones aritméticas seguras funcionando\n";
        std::cout << "✅ Operaciones de desplazamiento seguras funcionando\n";
        std::cout << "✅ Utilidades de rango funcionando\n";
        std::cout << "✅ Valor absoluto seguro funcionando\n";
        std::cout << "✅ Construcción segura funcionando\n";
