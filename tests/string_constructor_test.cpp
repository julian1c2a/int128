...
int main()
{
    ...
    std::cout << "Verificación: num1 == 12345: " << (num1 == uint128_t(12345) ? "✓" : "✗") << "\n";
    ...
    std::cout << "Verificación: num2 == 67890: " << (num2 == uint128_t(67890) ? "✓" : "✗") << "\n";
    ...
    std::cout << "Verificación: num3 == 999999999: " << (num3 == uint128_t(999999999) ? "✓" : "✗") << "\n";
    ...
    std::cout << "num4 > max_uint64: " << (num4 > max_uint64 ? "✓" : "✗") << "\n";
    ...
    std::cout << "Verificación: num5 == 12345: " << (num5 == uint128_t(12345) ? "✓" : "✗") << "\n";
    ...
    std::cout << "Ambos deben ser 0: " << (num6 == uint128_t(0) && num7 == uint128_t(0) ? "✓" : "✗") << "\n";
    ...
    std::cout << "small == 1: " << (small == uint128_t(1) ? "✓" : "✗") << "\n";
    std::cout << "medium == 1234567890: " << (medium == uint128_t(1234567890) ? "✓" : "✗") << "\n";
