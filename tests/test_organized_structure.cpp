...
int main()
{
    ...
    std::cout << "  ✅ uint128_t trivially_copyable: "
              << std::is_trivially_copyable_v<uint128_t> << "\n";
    std::cout << "  ✅ uint128_t standard_layout: " << std::is_standard_layout_v<uint128_t> << "\n";
    std::cout << "  ✅ int128_t trivially_copyable: "
              << std::is_trivially_copyable_v<int128_t> << "\n";
    std::cout << "  ✅ int128_t standard_layout: " << std::is_standard_layout_v<int128_t> << "\n";
    ...
    std::cout << "  ✅ Constructores directos funcionan\n";

    // 2. Factory functions
    auto u2 = make_uint128(0xABCD, 0x1234);
    auto i2 = make_int128(-999);
    std::cout << "  ✅ Factory functions funcionan\n";
    ...
    std::cout << "  ✅ Assign functions funcionan\n";
    ...
    std::cout << "  ✅ std::min/max cross-type funcionan\n";
    ...
    std::cout << "  ✅ Traits STL correctos\n";

    std::cout << "\n🎉 ¡NUEVA ESTRUCTURA FUNCIONA PERFECTAMENTE!\n";
    std::cout << "=============================================\n";
    std::cout << "✅ Header unificado: include/int128.hpp\n";
    std::cout << "✅ Organización clara: include/uint128/* + include/int128/*\n";
    std::cout << "✅ Balance óptimo: trivially_copyable + flexibilidad\n";
    std::cout << "✅ Todo funcional: constructores + factory + assign + std::min/max\n";
