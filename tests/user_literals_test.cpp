...
int main()
{
    ...
    std::cout << "Verificación: num1 == uint128_t(12345): " << (num1 == uint128_t(12345) ? "✓" : "✗") << "\n";
    ...
    std::cout << "Verificación: num3 == uint128_t(999): " << (num3 == uint128_t(999) ? "✓" : "✗") << "\n";
    ...
    std::cout << "huge2 > huge1: " << (huge2 > huge1 ? "✓" : "✗") << "\n";
    ...
    std::cout << "result1 == 300: " << (result1 == uint128_t(300) ? "✓" : "✗") << "\n";
    std::cout << "result2 == 2000: " << (result2 == uint128_t(2000) ? "✓" : "✗") << "\n";

    // Test 6: Comparaciones con literales
    std::cout << "\n6. Test comparaciones con literales:\n";
    std::cout << "42_u128 == 42_U128: " << (42_u128 == 42_U128 ? "✓" : "✗") << "\n";
    std::cout << "100_u128 < 200_u128: " << (100_u128 < 200_u128 ? "✓" : "✗") << "\n";
    std::cout << "\"1000\"_u128 >= \"999\"_U128: " << ("1000"_u128 >= "999"_U128 ? "✓" : "✗") << "\n";
    ...
    std::cout << "Todos los ceros son iguales: " << (zero1 == zero2 ? "✓" : "✗") << "\n";
    std::cout << "leading == 12345: " << (leading == uint128_t(12345) ? "✓" : "✗") << "\n";
    ...
    std::cout << "]\n";
    std::cout << "vec[3] == 1000: " << (vec[3] == uint128_t(1000) ? "✓" : "✗") << "\n";

    std::cout << "\n=== Resumen ===\n";
    std::cout << "✓ Literales _u128 y _U128 funcionan para números pequeños\n";
    std::cout << "✓ Literales de cadena manejan números grandes correctamente\n";
    std::cout << "✓ Aritmética con literales funciona naturalmente\n";
    std::cout << "✓ Comparaciones con literales son intuitivas\n";
    std::cout << "✓ Casos edge manejados correctamente\n";
    std::cout << "✓ Integración con contenedores STL\n";
