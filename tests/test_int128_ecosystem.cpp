...
void test_iostreams()
{
    ...
    std::cout << "\n[INFO] Testing iostream with manipulators:" << std::endl;
    ...
    std::cout << "\n[INFO] Testing width and fill:" << std::endl;
    ...
    // Test entrada
    std::cout << "\n[INFO] Testing input stream:" << std::endl;
    ...
    std::cout << "[OK] IOSTREAMS OK" << std::endl;
}
...
int main()
{
    ...
    try {
        ...
        std::cout << "[OK] int128_iostreams.hpp - Operadores iostream completos" << std::endl;
        std::cout << "[OK] int128_ranges.hpp - Algoritmos STL especializados" << std::endl;
