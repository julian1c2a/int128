...
int main()
{
    ...
    std::cout << "  ✓ int128_t is thread-safe for concurrent reads" << std::endl;
    std::cout << "  ✓ int128_t is thread-safe for thread-local modifications" << std::endl;
    std::cout << "  ✓ Signed operations (negate, is_negative) are thread-safe for reads"
              << std::endl;
