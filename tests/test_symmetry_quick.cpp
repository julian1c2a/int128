...
int main()
{
    ...
    std::cout << "  [OK] Resta simétrica" << std::endl;
    ...
    std::cout << "  [OK] División simétrica" << std::endl;
    ...
    assert(or1 == or2);
    std::cout << "  [OK] OR bitwise simétrico" << std::endl;
    ...
    assert(xor1 == xor2);
    std::cout << "  [OK] XOR bitwise simétrico" << std::endl;
    ...
    std::cout << "  [OK] Shift izquierdo" << std::endl;
    ...
    std::cout << "  [OK] Shift derecho" << std::endl;
