...
void test_signed_specific_features()
{
    ...
    std::cout << "✅ Signed specific features OK" << std::endl;
}
...
void test_negative_arithmetic()
{
    ...
    std::cout << "\n📊 Aritmética con números grandes:" << std::endl;
    ...
    std::cout << "\n📊 Multiplicación con signos:" << std::endl;
    ...
    std::cout << "✅ Negative arithmetic OK" << std::endl;
}
...
void test_division_with_signs()
{
    ...
    std::cout << "\n📊 División con diferentes signos:" << std::endl;
    ...
    std::cout << "\n📊 Módulo con diferentes signos:" << std::endl;
    std::cout << "100 % 7 = " << (dividend_pos % divisor_pos) << std::endl;
    std::cout << "100 % (-7) = " << (dividend_pos % divisor_neg) << std::endl;
    std::cout << "(-100) % 7 = " << (dividend_neg % divisor_pos) << std::endl;
    std::cout << "(-100) % (-7) = " << (dividend_neg % divisor_neg) << std::endl;
    ...
    std::cout << "✅ Division with signs OK" << std::endl;
}
...
void test_shift_arithmetic()
{
    ...
    std::cout << "\n📊 Shift aritmético derecho:" << std::endl;
    ...
    std::cout << "✅ Arithmetic shifts OK" << std::endl;
}
...
void test_comparisons_comprehensive()
{
    ...
    std::cout << "\n📊 Ordenamiento correcto:" << std::endl;
    for (int i = 0; i < 7; i++) {
    ...
    std::cout << "✅ Signed comparisons OK" << std::endl;
}
...
int main()
{
    ...
    try {
        ...
        std::cout << "✅ Complemento a 2 implementado correctamente" << std::endl;
        std::cout << "✅ MSB de data[1] funciona como bit de signo" << std::endl;
        std::cout << "✅ Aritmética con signo funcional" << std::endl;
        std::cout << "✅ Shifts aritméticos con extensión de signo" << std::endl;
        std::cout << "✅ Comparaciones correctas para números con signo" << std::endl;
        std::cout << "✅ Conversiones con saturación y clamp" << std::endl;
