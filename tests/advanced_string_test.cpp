...
int main()
{
    ...
    std::cout << "✓ Constructor desde cadena funciona\n";
    ...
    std::cout << "max_low.high() == 0: " << (max_low.high() == 0 ? "✓" : "✗") << "\n";
    std::cout << "max_low.low() == UINT64_MAX: " << (max_low.low() == UINT64_MAX ? "✓" : "✗") << "\n";
    ...
    std::cout << "just_over.high() == 1: " << (just_over.high() == 1 ? "✓" : "✗") << "\n";
    std::cout << "just_over.low() == 0: " << (just_over.low() == 0 ? "✓" : "✗") << "\n";
    ...
    std::cout << "10^19 > 10^18: " << (pow10_19 > pow10_18 ? "✓" : "✗") << "\n";
    ...
    std::cout << "leading_zeros == 12345: " << (leading_zeros == uint128_t(12345) ? "✓" : "✗") << "\n";
    ...
    std::cout << "Ambos deben ser 12345: " << (with_text == uint128_t(12345) && with_space == uint128_t(12345) ? "✓" : "✗") << "\n";
    ...
    std::cout << "Deben ser iguales: " << (from_str == manual ? "✓" : "✗") << "\n";
    ...
    std::cout << "zero1 (\"\") == 0: " << (zero1 == uint128_t(0) ? "✓" : "✗") << "\n";
    std::cout << "zero2 (\"0\") == 0: " << (zero2 == uint128_t(0) ? "✓" : "✗") << "\n";
    std::cout << "zero3 (\"   0   \") == 0: " << (zero3 == uint128_t(0) ? "✓" : "✗") << "\n";

    std::cout << "\n=== Resumen ===\n";
    std::cout << "✓ Constructor desde const char* funciona\n";
    std::cout << "✓ from_string() estático maneja const char* y std::string\n";
    std::cout << "✓ Parsing correcto de números grandes (>64 bits)\n";
    std::cout << "✓ Manejo correcto de espacios en blanco\n";
    std::cout << "✓ Parsing se detiene en caracteres no-dígito\n";
    std::cout << "✓ Casos edge (vacío, ceros) manejados correctamente\n";
