...
void test_arithmetic_functions()
{
    ...
    auto mid1 = nstd::midpoint(10_i128, 20_i128);
    auto mid2 = nstd::midpoint(-10_i128, 10_i128);
    auto mid3 = nstd::midpoint(-20_i128, -10_i128);
    ...
    auto abs1 = nstd::abs(42_i128);
    auto abs2 = nstd::abs(-42_i128);
    auto abs3 = nstd::abs(0_i128);
    auto abs_min = nstd::abs(int128_t_MIN);
...
void test_bit_functions()
{
    ...
    auto pop1 = nstd::popcount(7_i128);  // 0111 = 3 bits
    auto pop2 = nstd::popcount(15_i128); // 1111 = 4 bits
    auto pop3 = nstd::popcount(-1_i128); // Todos 1s = 128 bits
    auto pop4 = nstd::popcount(0_i128);  // 0000 = 0 bits
    ...
    auto clz1 = nstd::countl_zero(1_i128);  // 000...0001
    auto clz2 = nstd::countl_zero(0_i128);  // Todo ceros
    auto clz3 = nstd::countl_zero(-1_i128); // Empieza con 1
    ...
    auto ctz1 = nstd::countr_zero(8_i128); // 1000 = 3 ceros al final
    auto ctz2 = nstd::countr_zero(1_i128); // 0001 = 0 ceros al final
    auto ctz3 = nstd::countr_zero(0_i128); // Todo ceros
    ...
    auto bw1 = nstd::bit_width(7_i128);  // 111 = necesita 3 bits
    auto bw2 = nstd::bit_width(15_i128); // 1111 = necesita 4 bits
    auto bw3 = nstd::bit_width(0_i128);  // 0 = necesita 0 bits
    auto bw4 = nstd::bit_width(-1_i128); // negativo = usa todos
...
void test_power_of_2_functions()
{
    ...
    bool hsb1 = nstd::has_single_bit(8_i128);  // 1000 = potencia de 2
    bool hsb2 = nstd::has_single_bit(7_i128);  // 0111 = no es potencia de 2
    bool hsb3 = nstd::has_single_bit(1_i128);  // 0001 = potencia de 2
    bool hsb4 = nstd::has_single_bit(-8_i128); // negativo = no es potencia de 2
    ...
    auto bf1 = nstd::bit_floor(15_i128); // 15 -> 8 (mayor potencia de 2 <= 15)
    auto bf2 = nstd::bit_floor(16_i128); // 16 -> 16 (es potencia de 2)
    auto bf3 = nstd::bit_floor(1_i128);  // 1 -> 1
    auto bf4 = nstd::bit_floor(0_i128);  // 0 -> 0
...
void test_mathematical_functions()
{
    ...
    auto gcd1 = nstd::gcd(48_i128, 18_i128);  // gcd(48, 18) = 6
    auto gcd2 = nstd::gcd(-48_i128, 18_i128); // gcd(|-48|, |18|) = 6
    auto gcd3 = nstd::gcd(17_i128, 19_i128);  // gcd(17, 19) = 1 (primos)
    auto gcd4 = nstd::gcd(0_i128, 42_i128);   // gcd(0, 42) = 42
    ...
    auto lcm1 = nstd::lcm(4_i128, 6_i128);  // lcm(4, 6) = 12
    auto lcm2 = nstd::lcm(-4_i128, 6_i128); // lcm(|-4|, |6|) = 12
    auto lcm3 = nstd::lcm(7_i128, 11_i128); // lcm(7, 11) = 77 (primos)
    auto lcm4 = nstd::lcm(0_i128, 42_i128); // lcm(0, anything) = 0
...
int main()
{
    ...
    try {
        ...
        std::cout << "[OK] nstd::midpoint(int128_t, int128_t)" << std::endl;
        std::cout << "[OK] std::clamp(int128_t, int128_t, int128_t)" << std::endl;
        std::cout << "[OK] nstd::abs(int128_t)" << std::endl;
        std::cout << "[OK] std::popcount(int128_t)" << std::endl;
        std::cout << "[OK] nstd::countl_zero(int128_t)" << std::endl;
        std::cout << "[OK] nstd::countr_zero(int128_t)" << std::endl;
        std::cout << "[OK] nstd::bit_width(int128_t)" << std::endl;
        std::cout << "[OK] nstd::has_single_bit(int128_t)" << std::endl;
        std::cout << "[OK] nstd::bit_floor(int128_t)" << std::endl;
        std::cout << "[OK] nstd::gcd(int128_t, int128_t)" << std::endl;
        std::cout << "[OK] nstd::lcm(int128_t, int128_t)" << std::endl;
