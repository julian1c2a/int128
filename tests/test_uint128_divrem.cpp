...
{
    std::cout << "test_divrem_basic ......" << std::endl;
    ...
    std::cout << "test_divrem_basic passed" << std::endl;
}

void test_divrem_zero()
{
    std::cout << "test_divrem_zero ......" << std::endl;
    uint128_t a = 100_u128;
    auto res = a.divrem(0_u128);
    assert(!res.has_value());
    std::cout << "test_divrem_zero passed" << std::endl;
}

void test_divrem_large()
{
    std::cout << "test_divrem_large ......" << std::endl;
    // 2^100
    ...
    std::cout << "test_divrem_large passed" << std::endl;
}
