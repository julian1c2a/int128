#!/usr/bin/env bash
# ==============================================================================
# build_uint128_numeric_extracted_tests.bash
# ==============================================================================
# Compiles uint128 numeric tests with all 4 compilers (GCC, Clang, Intel, MSVC)
# Output: build/build_tests/{compiler}/{debug|release}/uint128_numeric_tests_{compiler}[.exe]
# ==============================================================================
...
echo_info "Building uint128 numeric tests for all compilers..."
echo ""
...
echo ""
echo_success "Build complete for uint128 numeric tests!"
