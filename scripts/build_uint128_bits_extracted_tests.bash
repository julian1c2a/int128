#!/usr/bin/env bash
# ==============================================================================
# build_uint128_bits_extracted_tests.bash
# ==============================================================================
# Compiles uint128 bits tests with all 4 compilers (GCC, Clang, Intel, MSVC)
# Output: build/build_tests/{compiler}/{debug|release}/uint128_bits_tests_{compiler}[.exe]
# ==============================================================================
...
TYPE="uint128"
FEATURE="bits"
TEST_FILE="tests/uint128_bits_extracted_tests.cpp"
...
echo_info "Building uint128 bits tests for all compilers..."
echo ""
...
echo ""
echo_success "Build complete for uint128 bits tests!"
