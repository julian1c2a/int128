#!/bin/bash
# Script para compilar benchmarks de int128_traits
# Uso: ./build_int128_traits_extracted_benchs.bash [gcc|clang|intel|msvc|all] [debug|release]
...
echo -e "${BLUE}============================================================${NC}"
echo -e "${BLUE}  Compilación de int128_traits benchmarks${NC}"
...
# Archivos
BENCH_SRC="${PROJECT_DIR}/benchmarks/int128_traits_extracted_benchs.cpp"
...
build_gcc() {
    ...
    local OUTPUT="build/build_benchmarks/gcc/${MODE}/int128_traits_benchs_gcc"
...
build_clang() {
    ...
    local OUTPUT="build/build_benchmarks/clang/${MODE}/int128_traits_benchs_clang"
...
build_intel() {
    ...
    local OUTPUT="build/build_benchmarks/intel/${MODE}/int128_traits_benchs_intel.exe"
    ...
    icx $FLAGS \
        ...
        -o build/build_benchmarks/intel/${MODE}/int128_traits_benchs_intel.exe
