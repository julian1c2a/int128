...
run_gcc() {
    ...
    local EXECUTABLE="build/build_benchs/gcc/${MODE}/int128_traits_benchs_gcc"
...
run_clang() {
    ...
    local EXECUTABLE="build/build_benchs/clang/${MODE}/int128_traits_benchs_clang"
...
run_intel() {
    ...
    local EXECUTABLE="build/build_benchs/intel/${MODE}/int128_traits_benchs_intel.exe"
...
run_msvc() {
    ...
    local EXECUTABLE="build/build_benchs/msvc/${MODE}/int128_traits_benchs_msvc.exe"
