...
run_gcc() {
    ...
    local EXECUTABLE="build/build_benchmarks/gcc/${MODE}/uint128_traits_benchs_gcc"
...
run_clang() {
    ...
    local EXECUTABLE="build/build_benchmarks/clang/${MODE}/uint128_traits_benchs_clang"
...
run_intel() {
    ...
    local EXECUTABLE="build/build_benchmarks/intel/${MODE}/uint128_traits_benchs_intel.exe"
...
run_msvc() {
    ...
    local EXECUTABLE="build/build_benchmarks/msvc/${MODE}/uint128_traits_benchs_msvc.exe"
