#!/usr/bin/env bash
# ==============================================================================
# build_int128_algorithm_extracted_tests.bash
# ==============================================================================
# Compiles int128 algorithm tests with all 4 compilers (GCC, Clang, Intel, MSVC)
# Output: build/build_tests/{compiler}/{debug|release}/int128_algorithm_tests_{compiler}[.exe]
# ==============================================================================
...
TYPE="int128"
FEATURE="algorithm"
TEST_FILE="tests/test_${TYPE}_${FEATURE}.cpp"
...
echo_info "Building int128 algorithm tests for all compilers..."
echo ""
...
echo ""
echo_success "Build complete for int128 algorithm tests!"
