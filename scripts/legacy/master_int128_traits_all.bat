@echo off
REM Script maestro para compilar y ejecutar todo el proceso de int128_traits tests y benchmarks
...
echo ============================================================
echo   int128_traits.hpp - Proceso Completo
...
call scripts\compile_int128_traits_extracted.bat
...
call scripts\run_int128_traits_benchmarks.bat
