#!/usr/bin/env bash
# ==============================================================================
# check_direct.bash - Ejecutar test directamente en consola
# ==============================================================================
# Ejecuta un test compilado mostrando toda la salida en consola
# Sin formateo de colores, sin matriz de resultados - output directo
# 
# Par con: build_tests_generic.bash
# 
# Uso:
#   check_direct.bash <feature> [compiler] [mode]
#
# Argumentos:
...
#
# Ejemplos:
#   check_direct.bash tt
#   check_direct.bash bits gcc release
#   check_direct.bash cmath clang debug
# ==============================================================================
...
if [[ "$FEATURE" == "all" ]]; then
    echo "========================================="
    echo " Checking ALL features (direct)"
    echo "========================================="
...
EXE_NAME="int128_${FEATURE}_tests_${COMPILER}"
...
EXE_PATH="build/build_tests/${COMPILER}/${MODE}/${EXE_NAME}"

if [[ ! -f "$EXE_PATH" ]]; then
    echo "Error: Ejecutable no encontrado: $EXE_PATH"
    echo ""
    echo "Primero compila con:"
    echo "  bash scripts/build_tests_generic.bash ${FEATURE} ${COMPILER} ${MODE}"
    exit 1
fi
