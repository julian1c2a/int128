#!/usr/bin/env bash
# ==============================================================================
# build_benchs_generic.bash - Script genérico para compilar benchmarks
# ==============================================================================
# Compila benchmarks con todos los compiladores
# Par con: run_generic.bash
# 
# Uso:
#   build_benchs_generic.bash <feature> [compiler] [mode] [print]
#
# Argumentos:
...
#
# Nota: Busca primero archivo unificado (int128_*) y si no existe, busca legacy (uint128_*/int128_*)
#
# Ejemplos:
#   build_benchs_generic.bash bits
#   build_benchs_generic.bash numeric gcc release
#   build_benchs_generic.bash algorithm all all yes
# ==============================================================================
...
if [[ "$FEATURE" == "all" ]]; then
    echo "========================================="
    echo " Building ALL features (benchmarks)"
    echo "========================================="
...
# Template unificado siempre usa int128_<feature>_extracted_benchs.cpp
SOURCE_FILE="benchs/int128_${FEATURE}_extracted_benchs.cpp"

echo_info "Building benchmarks for feature '$FEATURE' (unified template)..."

# ========================= Check Source File =========================

if [[ ! -f "$SOURCE_FILE" ]]; then
    echo_error "Source file not found. Tried:"
    echo_error "  benchs/int128_${FEATURE}_extracted_benchs.cpp"
    echo_error "  benchs/uint128_${FEATURE}_extracted_benchs.cpp"
    exit 1
fi
...
compile_with() {
    ...
    for mode in "${modes_to_compile[@]}"; do
        ...
        # Output: int128_<feature>_benchs_<compiler>
        local output="$output_dir/int128_${FEATURE}_benchs_${compiler_name}"
...
echo_success "Build benchmarks complete for feature '$FEATURE'!"
