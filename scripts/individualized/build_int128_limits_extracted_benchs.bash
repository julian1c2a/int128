...
echo "   [OK] GCC Debug: build/int128_limits_extracted_benchs/gcc/debug/int128_limits_extracted_benchs"
...
echo "   [OK] GCC Release: build/int128_limits_extracted_benchs/gcc/release/int128_limits_extracted_benchs"
fi
...
echo "   [OK] Clang Debug: build/int128_limits_extracted_benchs/clang/debug/int128_limits_extracted_benchs"
...
echo "   [OK] Clang Release: build/int128_limits_extracted_benchs/clang/release/int128_limits_extracted_benchs"
fi
...
if ! command -v icx &> /dev/null; then
    ...
    echo "   [OK] Intel ICX Debug: build/int128_limits_extracted_benchs/intel/debug/int128_limits_extracted_benchs.exe"
    ...
    echo "   [OK] Intel ICX Release: build/int128_limits_extracted_benchs/intel/release/int128_limits_extracted_benchs.exe"
