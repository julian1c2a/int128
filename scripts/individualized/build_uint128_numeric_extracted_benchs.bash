#!/usr/bin/env bash
# ==============================================================================
# build_uint128_numeric_extracted_benchs.bash
# ==============================================================================
# Compiles uint128 numeric benchmarks with all 4 compilers (GCC, Clang, Intel, MSVC)
# Output: build/build_benchmarks/{compiler}/{debug|release}/uint128_numeric_benchmarks_{compiler}[.exe]
# ==============================================================================
...
echo_info "Building uint128 numeric benchmarks for all compilers..."
echo ""
...
echo ""
echo_success "Build complete for uint128 numeric benchmarks!"
