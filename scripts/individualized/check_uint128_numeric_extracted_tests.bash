#!/usr/bin/env bash
# ==============================================================================
# check_uint128_numeric_extracted_tests.bash
# ==============================================================================
# Executes uint128 numeric test binaries across all compilers and modes
...
TYPE="uint128"
FEATURE="numeric"
TEST_SOURCE="test_numeric_functions"
...
echo_header "========================================================================"
echo_header "  UINT128 NUMERIC TESTS - Execution"
echo_header "========================================================================"
echo ""
