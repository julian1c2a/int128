#!/usr/bin/env bash
# ==============================================================================
# build_int128_iostreams_extracted_tests.bash
# ==============================================================================
# Compiles int128 iostreams tests with all 4 compilers (GCC, Clang, Intel, MSVC)
# Output: build/build_tests/{compiler}/{debug|release}/int128_iostreams_tests_{compiler}[.exe]
# ==============================================================================
...
echo_info "Building int128 iostreams tests for all compilers..."
echo ""
...
echo ""
echo_success "Build complete for int128 iostreams tests!"
