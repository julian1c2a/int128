...
if [ $? -eq 0 ]; then
    echo -e "${GREEN}✓ Compilación con ThreadSanitizer exitosa${NC}"
    GCC_TSAN=0
else
...
echo "  ✓ uint128_t es thread-safe para lecturas concurrentes"
echo "  ✓ uint128_t es thread-safe para objetos thread-local"
