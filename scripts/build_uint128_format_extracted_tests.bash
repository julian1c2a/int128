#!/usr/bin/env bash
# ==============================================================================
# build_uint128_iostreams_extracted_tests.bash
# ==============================================================================
# Compiles uint128 iostreams tests with all 4 compilers (GCC, Clang, Intel, MSVC)
# Output: build/build_tests/{compiler}/{debug|release}/uint128_iostreams_tests_{compiler}[.exe]
# ==============================================================================
...
echo_info "Building uint128 iostreams tests for all compilers..."
echo ""
...
echo ""
echo_success "Build complete for uint128 iostreams tests!"
