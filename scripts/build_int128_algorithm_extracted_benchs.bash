#!/usr/bin/env bash
# ==============================================================================
# build_int128_algorithm_extracted_benchs.bash
# ==============================================================================
# Compiles int128 algorithm benchmarks with all 4 compilers (GCC, Clang, Intel, MSVC)
# Output: build/build_benchmarks/{compiler}/{debug|release}/int128_algorithm_benchmarks_{compiler}[.exe]
# ==============================================================================
...
echo_info "Building int128 algorithm benchmarks for all compilers..."
echo ""
...
echo ""
echo_success "Build complete for int128 algorithm benchmarks!"
