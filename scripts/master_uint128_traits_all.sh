#!/bin/bash
# Script maestro para compilar y ejecutar todo el proceso de uint128_traits tests y benchmarks
...
echo -e "${BLUE}============================================================${NC}"
echo -e "${BLUE}  uint128_traits.hpp - Proceso Completo${NC}"
...
if ./scripts/compile_uint128_traits_extracted.sh; then
...
if ./scripts/run_uint128_traits_benchmarks.sh; then
