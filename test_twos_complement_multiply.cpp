// Test para verificar identidades de multiplicacion en complemento a 2
...
void test_case_1_neg_neg()
{
    ...
    // Test con valores pequenos: -5 * -3 = 15
    int128_t n1(-5);
    int128_t m1(-3);
    ...
    // Verificar que la representacion unsigned da el mismo resultado
...
void test_case_2_neg_pos()
{
    ...
    // Verificar que la multiplicacion unsigned da el mismo resultado
    uint128_t u_n1 = *reinterpret_cast<uint128_t*>(&n1);
    uint128_t u_m1 = *reinterpret_cast<uint128_t*>(&m1);
    uint128_t u_result1 = u_n1 * u_m1;
    int128_t converted_result1 = *reinterpret_cast<int128_t*>(&u_result1);
...
void test_case_3_pos_neg()
{
    ...
    std::cout << "\nVerificacion unsigned: 1000 * (-500)\n";
...
void test_edge_cases()
{
    ...
    // Test: MIN * -1 = overflow (deberia wrap)
    ...
    std::cout << "Nota: Deberia hacer wrap a MIN (complemento a 2)\n";
    ...
    std::cout << "Nota: Deberia hacer overflow (wrap-around)\n";
}

int main()
{
    std::cout << "===============================================================\n";
    std::cout << "  TEST: Identidades de Multiplicacion en Complemento a 2\n";
    std::cout << "===============================================================\n";
    ...
    std::cout << "  CONCLUSION\n";
    std::cout << "===============================================================\n";
    std::cout << "\nOK La multiplicacion en complemento a 2 funciona automaticamente\n";
    ...
    std::cout << "\nOK IMPLICACION: Puedes usar multiplicacion unsigned directamente\n";
    std::cout << "  para int128_t sin ningun 'if' para manejar signos.\n";
