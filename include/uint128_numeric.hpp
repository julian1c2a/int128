...
constexpr uint128_t byteswap(uint128_t x) noexcept
{
    ...
    uint64_t high_swapped = __builtin_bswap64(x.low());
    uint64_t low_swapped = __builtin_bswap64(x.high());
...
// ===============================================================================
// FUNCIONES DE RANGO C++11/17 - ESPECIALIZACIONES STD
// ===============================================================================
...
/**
 * @brief Acumula valores en un rango con tipo uint128_t
 *
 ...
 * @return Suma acumulada desde init
 *
 * Especialización de std::accumulate para uint128_t
 */
...
/**
 * @brief Acumula valores en un rango con operación personalizada
 *
 * @tparam InputIt Tipo de iterador de entrada
 * @tparam BinaryOperation Tipo de operación binaria
 * @param first Iterador al inicio del rango
 * @param last Iterador al final del rango
 * @param init Valor inicial del acumulador
 * @param op Operación binaria a aplicar
...
/**
 * @brief Calcula el producto inner (producto escalar) de dos rangos
 *
 * @tparam InputIt1 Tipo de iterador del primer rango
 * @tparam InputIt2 Tipo de iterador del segundo rango
 * @param first1 Iterador al inicio del primer rango
 * @param last1 Iterador al final del primer rango
 * @param first2 Iterador al inicio del segundo rango
 * @param init Valor inicial del acumulador
 * @return Producto escalar de los dos rangos
 */
 ...
 *
 * Especialización de std::partial_sum para uint128_t
 */
 ...
 * @return Iterador al final del rango de salida
 *
 * Especialización de std::adjacent_difference para uint128_t
 */
template <class InputIt, class OutputIt>
