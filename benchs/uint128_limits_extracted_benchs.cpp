/*
 * Benchmarks para uint128_limits.hpp
 * Mide el rendimiento de acceso a std::numeric_limits<uint128_t>
 */
...
void benchmark_limits_constants()
{
    ...
    benchmark("limits::lowest()",
              []() { [[maybe_unused]] auto v = std::numeric_limits<uint128_t>::lowest(); });
}
...
void benchmark_limits_properties()
{
    ...
    benchmark("limits::digits10",
              []() { [[maybe_unused]] auto v = std::numeric_limits<uint128_t>::digits10; });

    benchmark("limits::max_digits10",
              []() { [[maybe_unused]] auto v = std::numeric_limits<uint128_t>::max_digits10; });

    benchmark("limits::is_signed",
              []() { [[maybe_unused]] auto v = std::numeric_limits<uint128_t>::is_signed; });

    benchmark("limits::is_integer",
              []() { [[maybe_unused]] auto v = std::numeric_limits<uint128_t>::is_integer; });

    benchmark("limits::is_exact",
              []() { [[maybe_unused]] auto v = std::numeric_limits<uint128_t>::is_exact; });

    benchmark("limits::is_bounded",
              []() { [[maybe_unused]] auto v = std::numeric_limits<uint128_t>::is_bounded; });

    benchmark("limits::is_modulo",
              []() { [[maybe_unused]] auto v = std::numeric_limits<uint128_t>::is_modulo; });
}
...
{
    std::cout << "========================================\n";
    std::cout << "uint128_t Limits Benchmarks\n";
    std::cout << "========================================\n";
