 ...
 */
template <signedness S> inline constexpr int popcount(const int128_base_t<S>& value) noexcept
{
 ...
 */
template <signedness S> inline constexpr int countl_zero(const int128_base_t<S>& value) noexcept
{
 ...
 */
template <signedness S> inline constexpr int countr_zero(const int128_base_t<S>& value) noexcept
{
    if (value.low() != 0) {
 ...
 */
template <signedness S> inline constexpr int countl_one(const int128_base_t<S>& value) noexcept
{
 ...
 */
template <signedness S> inline constexpr int countr_one(const int128_base_t<S>& value) noexcept
{
    constexpr uint64_t ALL_ONES = ~uint64_t(0);
 ...
 */
template <signedness S> inline constexpr int bit_width(const int128_base_t<S>& value) noexcept
{
    if constexpr (S == signedness::signed_type) {
        if (value.is_negative()) {
 ...
 */
template <signedness S> inline constexpr bool has_single_bit(const int128_base_t<S>& value) noexcept
{
    if constexpr (S == signedness::signed_type) {
 ...
 */
template <signedness S> inline constexpr int find_first_set(const int128_base_t<S>& value) noexcept
{
    if (value.is_zero()) {
        return -1;
    }
 ...
 */
template <signedness S> inline constexpr int find_last_set(const int128_base_t<S>& value) noexcept
{
    if (value.is_zero()) {
        return -1;
    }
